...
| Time          | Activity                                                             |
|---------------|---------------------------------------------------------------------|
| 09:00 – 09:30 | [Introduction + Overview](slides/01-intro/index.html)               |
...
[Principal Programmer, GSK Immunology Therapeutic Area]{.instructor-role}

At GSK since 2018, Ben has led and helped with many initiatives around R adoption within Clinical Programming. He actively helps develop and maintain an end-to-end R package pipeline, [pharmaverse](https://pharmaverse.org/), that addresses the needs of Clinical Reporting with many awesome companies and individuals. He is very excited for the future of using R and open source for Clinical Reporting.
:::

::: {.instructor-card}
![](images/ram-circle.png){fig-alt="Headshot of Rammprasad Ganapathy"}

[**Rammprasad Ganapathy**]{.instructor-name}

[Principal Data Scientist, Roche/Genentech]{.instructor-role}

Ram has over 15 years of experience in EDC clinical programming and statistical programming. He leads the OAK team and is the author of the R packages {roak} and its open-source counterpart, {sdtm.oak}. Ram and his team developed the R-based SDTM automation solution, OAK, taking it from a proof of concept to full-scale implementation.
:::
