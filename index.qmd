...
🗓️ September 14, 2026  09:00 - 17:00 
...
tibble::tribble(
  ~time, ~desc,
  "09:00 - 10:00", "[Introduction + Overview](slides/01-intro/index.html)",
  "10:00 - 10:30", "[SDTM](slides/02-SDTM/index.html)", 
...
- [ ] Bookmark this site. You'll reference it throughout the workshop.   [pos.it/pharmaverse-conf26](pos.it/pharmaverse-conf26)
...
<br>
![](images/ben-circle.jpg){style="float:left;padding: 0 20px 0 20px;" fig-alt="Headshot of Ben Straub" width="140"}
...
![](images/magda-circle.png){style="float:left;padding: 0 20px 0 20px;"
fig-alt="Headshot of Magdalena Krochmal" width="140"}

**Magdalena Krochmal*** (Magda) is a Senior Real-Time Visual Analytics Specialist at Roche with over a decade of experience bridging the gap between advanced data engineering and user-centered application design. With a strong focus on clinical submission innovations, she is actively involved in the development and implementation of the SDTM automation project, {roak}. Magda leverages her expertise in R, Shiny, and AI-driven workflows to engineer intuitive medical data review tools, taking complex clinical data and translating it into high-impact, interactive visual analytics.

[`r fontawesome::fa("linkedin", fill = "#606060")`](https://www.linkedin.com/in/magdalena-krochmal/)
