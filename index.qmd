...
[**Daniel D. Sjoberg**](https://www.danieldsjoberg.com/) (he/him) is Executive Director of Data Sciences and Clinical Data Analytics at Kardigan. Previously, he was a Senior Principal Innovation Data Scientist and Real-time Analytics Group Lead at Genentech, a Lead Data Science Manager at the Prostate Cancer Clinical Trials Consortium, and spent 13 years as an academic biostatistician at Memorial Sloan Kettering Cancer Center in New York City. He enjoys R package development, creating many packages available on [CRAN](https://cran.r-project.org/web/packages/), [R-Universe](https://ddsjoberg.r-universe.dev/ui#packages), and [GitHub](https://github.com/ddsjoberg). He's a co-organizer of [rainbowR](https://rainbowr.netlify.app/) (a community that supports, promotes, and connects LGBTQ+ people who code in the R language) and of the [R Medicine Conference](https://rconsortium.github.io/RMedicine_website/). His research interests include adaptive methods in clinical trials, precision medicine, and predictive modeling. Daniel is the recipient of the Brian Bole Award for Excellence from Open Source in Pharma and the American Statistical Association (ASA) Innovation in Programming Award.
