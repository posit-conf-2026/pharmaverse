...
::: {.small}
Lives at `.claude/skills/gtsummary-tables/SKILL.md`. Bundle reference files (a crane catalog, worked examples) beside it. Skills are portable across Claude Code, claude.ai, and the API.
:::
