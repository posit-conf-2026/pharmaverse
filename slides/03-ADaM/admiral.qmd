...
::: {.callout-note}
Placeholder - to be fleshed out with the specific prompts/demos we'll run live.
:::
...
-   Live demo(s) TBD - e.g., asking it to adapt a script snippet for a new parameter.
:::
