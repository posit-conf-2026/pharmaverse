...
1. Navigate to Posit Cloud script `exercises/05-tables-tfrmt.R` #todo add docorator

2. Update the demog table from the slides as described. 

3. Create, modify, and output the AE table as described.

4. Add the "completed" sticky note to your laptop when complete.
