...
3. Click Sign in to try Posit AI for free and authorize in your browser. Create your Posit AI account at posit.ai using the same email you registered for the workshop with — that's how your workshop credits attach.
4. Optional: turn on inline completions with Tools → Global Options → Assistant and pick Posit AI Next Edit Suggestions from the "Use code assistant" dropdown. These are unlimited and free — they don't draw on credits at all.

5. Ask your Posit Assistant to list all the instaled pharmaverse packages!
