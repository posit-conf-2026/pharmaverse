...
-   By the end of this tables section you will have:
    ...
    - Developed an understanding of how docorator generates different types of output documents
...
-   🕚 5 mins: cards-to-tfrmt helpers

-   🕦 5 mins: Outputs using `docorator`
...
* The same pattern extends to as many layers as needed (org → therapeutic area → study)
