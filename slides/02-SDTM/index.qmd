...
are coded. The **last one we do together** (**CMINDC**) shows how to **prompt the
AI** to fill a mapping. Then it's your turn: complete the **7 exercises** — each
has the aCRF annotation and a suggested prompt.
