...
-   **Verify** the result against Barb's known VS numbers.
:::
...
[[✅]{.pv-ico}Verify with Barb]{.pv-step}
:::
...
::: {.pv-ai}
[🧑‍⚖️]{.pv-ico} Same shape as our hand-written blocks — **you stay the reviewer**: check the CT code, run it, confirm Barb looks right.
:::
...
::: {.pv-ai}
[🧑‍⚖️]{.pv-ico} You **review each row** against the aCRFs — correct source, date format, min vs max — then run and check Barb.
:::
