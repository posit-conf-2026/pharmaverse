...
Open exercises/02-SDTM.R — map the **AE** domain. Two ways to tackle it:

- [✍️]{.pv-ico} **Code it yourself** — write each `sdtm.oak` call by hand, as we did for CM.
- [🤖]{.pv-ico} **Use the AI agent + skill** — prompt it to draft the script from the AE aCRF, then review and run.
